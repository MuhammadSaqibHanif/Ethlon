...
class DriverDrawer  extends React.Component {
  ...
  <View style={{height:Dimensions.get('window').height,backgroundColor:"white"}}>
      ...
      <View style={{backgroundColor:'#e1b827',height:'25%',width:'100%'}}>
          <Text style={{marginTop:"20%",marginLeft:30,color:'white',fontSize:18,fontWeight:'500'}}>
       Name :
          </Text>
          <Text style={{marginLeft:30,color:'white',fontSize:14,fontWeight:'500'}}>
        Number :
          </Text>
          <Text style={{marginLeft:30,color:'white',fontSize:14,fontWeight:'500'}}>
     Email :
     ...
     <View>
         <View style={{backgroundColor:'#E9E9E9'}}>
             <Text style={{fontSize:16,fontWeight:'500',marginLeft:10,marginVertical:5,color:'gray'}}>
                 More Options
             </Text>
         </View>
         ...
         <TouchableOpacity onPress={()=>navigate('')}>
         <View style={{flexDirection:'row', marginLeft:15,marginVertical:10}}>
                <Image source={require('../images/shopping-bag.png')} style={{width:20,height:20}} />
         ...
         <TouchableOpacity onPress={()=>navigate('')}>
         <View style={{flexDirection:'row', marginLeft:15,marginVertical:10}}>
                <Image source={require('../images/rating1.png')} style={{width:20,height:20}} />
         ...
         <TouchableOpacity onPress={()=>navigate('')}>
         <View style={{flexDirection:'row', marginLeft:15,marginVertical:10}}>
                <Image source={require('../images/closed-lock.png')} style={{width:20,height:20}} />
         ...
         <View style={{flexDirection:'row', marginLeft:10,marginVertical:10}}>
                <Image source={require('../images/support.png')} style={{width:20,height:20}} />
                <Text style={{fontSize:14, marginLeft:10}}>Contact Support</Text>
         </View>
