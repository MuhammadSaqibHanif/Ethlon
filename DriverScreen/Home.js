...
<Header style={{ backgroundColor: '#e1b827' }}>
                <Body style={{ flex: 1, justifyContent: 'flex-start', flexDirection: 'row', marginLeft: 8 }}>
                    ...
                    <Image    source={require('../images/menus.png')} style={{height:15,width:15,marginTop:2}}/>
                    </TouchableOpacity>
   </View>
   <View style={{ flexDirection:'row',justifyContent:'center' }}>
                        <Text style={{ marginLeft:"42%",fontSize: 20, color: 'white', fontWeight: '500' }}>Affro Eat</Text>
                    </View>
                </Body>
                <TouchableOpacity onPress={()=>navigate('')}>
                <View style={{justifyContent: 'flex-end', flexDirection: 'row',marginTop:20 }}>
                    <Image source={require("../images/cart.png")} style={{height:25,width:25,marginTop:-5}}/>
                </View>
                </TouchableOpacity>
            </Header>
